...
const SHIELD_STYLE_HINTS = {
  ...
  kitex: { color: '00ADD8', logo: 'kimi', logoColor: 'white' },
  apachethrift: { color: 'D22128', logo: 'ethereum', logoColor: 'white' },
  hertz: { color: '0D9488', logo: 'hetzner', logoColor: 'white' },
  ...
  cloudflare: { color: 'F38020', logo: 'cloudflare', logoColor: 'white' },
...
const portfolioProjectTopicMap = {
  ...
  'AI News Briefing - Automated Research Ops Pipeline': ['Agentic AI', 'AI', 'Productivity', 'Cross-Platform'],
  ...
  'Diffuse - Local-First Device History': ['Cross-Platform', 'Mobile', 'Productivity', 'Data'],
  ...
  'The 2048 Game': ['Game', 'Cross-Platform', 'Mobile'],
